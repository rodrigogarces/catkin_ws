...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ratslam_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/raphael/catkin_ws/install/${idir}'.  Ask the maintainer 'David Ball <davidmichaelball@gmail.com>' to fix it.")
    endif()
